...
<head>
    ...
    <![endif]-->
    <title>添加订单 - 订单管理 - H-ui.admin v3.1</title>
...
<article class="page-container">
    <form class="form form-horizontal" method="post" action="order/update" id="orderForm">
        <!-- 隐藏域 ，订单状态-->
        <input type="hidden" name="orderStatus" value="${selectedOrder.orderStatus}">
        <%--隐藏域，订单ID--%>
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <select name="userId">
                        <c:forEach items="${users}" var="user">
                            <option value="${user.userId}" ${selectedOrder.userId eq user.userId ? 'selected' : ''}>${user.realname}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <select name="customerId" id="customerId">
                        <c:forEach items="${customers}" var="customer">
                            <option data-base_id="${customer.locationId}" value="${customer.customerId}" ${selectedOrder.customerId eq customer.customerId ? 'selected' : ''}>${customer.customerName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <select id="area" name="intervalId">
                        <c:forEach items="${areas}" var="area">
                            <option value="${area.baseId}" ${area.baseId eq selectedOrder.intervalId ? 'selected' : ''}>${area.baseName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
        ...
        <div class="row cl">
            <div class="col-xs-4 col-sm-4">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="${selectedOrder.shippingAddress}" required="required"  placeholder="" id="shippingAddress" name="shippingAddress">
                </div>
            </div>
            <div class="col-xs-4 col-sm-4">
                <label class="form-label col-xs-4 col-sm-4">收货人：</label>
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="${selectedOrder.shippingName}" required="required"   placeholder="" id="shippingName" name="shippingName">
                </div>
            </div>
            <div class="col-xs-4 col-sm-4">
                <label class="form-label col-xs-4 col-sm-4">收货人电话：</label>
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="${selectedOrder.shippingPhone}" required="required"  placeholder="" id="shippingPhone" name="shippingPhone">
                </div>
            </div>
        </div>
        <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <select name="paymentMethodId">
                        <c:forEach items="${payments}" var="payment">
                            <option value="${payment.baseId}" ${selectedOrder.paymentMethodId eq payment.baseId ? 'selected' : ''}>${payment.baseName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <select name="freightMethodId">
                        <c:forEach items="${transports}" var="transport">
                            <option value="${transport.baseId}" ${selectedOrder.freightMethodId eq transport.baseId ? 'selected' : ''}>${transport.baseName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <select name="takeMethodId">
                        <c:forEach items="${pickups}" var="pickup">
                            <option value="${pickup.baseId}" ${selectedOrder.takeMethodId eq pickup.baseId ? 'selected' : ''}>${pickup.baseName}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
        ...
        <div class="row cl">
            <div class="col-xs-4 col-sm-4">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="${selectedOrder.takeName}"   placeholder="" id="takeName" name="takeName">
                </div>
            </div>
            <div class="col-xs-4 col-sm-4">
                <label class="form-label col-xs-4 col-sm-4">实收件地址：</label>
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="${selectedOrder.takeAddress}"   placeholder="" id="takeAddress" name="takeAddress">
                </div>
            </div>
            <div class="col-xs-4 col-sm-4">
                <label class="form-label col-xs-4 col-sm-4">收件人电话：</label>
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="${selectedOrder.takePhone}"   placeholder="" id="takePhone" name="takePhone">
                </div>
            </div>
        </div>
        <div class="row cl">
            <div class="col-xs-4 col-sm-4">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <textarea name="orderRemark" cols="" rows="" class="textarea"  placeholder="说点啥？" >${selectedOrder.orderRemark}</textarea>
                </div>
            </div>
        </div>
                    ...
                    <div  class="col-xs-2 col-sm-1 order_detail">
                        <select name="orderDetails[][goodsUnit]">
                            <c:forEach items="${units}" var="unit">
                                <option value="${unit.baseId}" ${orderDetail.goodsUnit eq unit.baseId ? 'selected' : ''}>${unit.baseName}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div  class="col-xs-2 col-sm-2 order_detail">
                        <input type="text" name="orderDetails[][goodsUnitPrice]" value="${orderDetail.goodsUnitPrice}">

                    </div>
                    <div  class="col-xs-2 col-sm-2 order_detail">
                        <input type="text" name="orderDetails[][goodsTotal]" readonly value="${orderDetail.goodsTotal}">
                    </div>
