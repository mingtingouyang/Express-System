...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add" action="permission/insert" method="post">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="" placeholder="" id="expression" name="expression">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>权限类型：</label>
            <div class="formControls col-xs-8 col-sm-9">
                菜单权限：<input type="radio" class="input-radio" name="type" value="menu">
                普通权限：<input type="radio" class="input-radio" name="type" value="permission">
            </div>
        </div>
        <div class="row cl">
