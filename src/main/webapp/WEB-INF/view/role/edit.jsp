...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add" action="role/update" method="post">
        ...
        let setting = {
            ...
            callback: {
                onAsyncSuccess: function () {
                    ...
                    let permissionIdsArr = '${role.permissionIds}'.split(",")

                    for (let i = 0; i < permissionIdsArr.length; i++) {
                        let node = treeObj.getNodeByParam("permissionId", permissionIdsArr[i])
